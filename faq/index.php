...
<body>
        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>One of the many great things about Car Rental is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable vehicle including the same terms, locations, and rental car fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>
 ...
 <div class="w3-content w3-container w3-padding-64" id="contact">
        <h3 class="w3-center">ASK QUESTION</h3>
        <p class="w3-center"><em>It will be our pleasure to answer your queries!</em></p>

        <div class="w3-row w3-padding-32 w3-section">
            <div class="w3-col w3-panel">
                <div class="w3-large w3-margin-bottom">

                <form action="/carproject/action_page.php?type=question" method="POST">
